...
# faces klasöründeki resimler ile eğitme işlemi yapıldı.
def trainFaces():
...
##Yüz bulunduysa yüzün etrafını çizer.
...
trainFaces()
# form Components
btnOpenFile = Button(text="Recognize from photos(Dosyadan resim ekle)", command=openFile)
lblTag = Label(text="",
               bg="red", fg="white", font="Arial 18")
lblImage = Label()
btnOpenCamera = Button(text="Recognize from camera(kameradan görüntü Al.)", command=openCamera)
